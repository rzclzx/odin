        ...
        MENU_ARRAY: [
            {
                ...
                childs: [
                    {
                        name: "广告项目管理",
                        nav: "/home/project/projectList"
                    },
                    {
                        name: "推广活动管理",
                        nav: "/home/campaign/campaignAudited"
                    }
                ]
            },
            {
                ...
                childs: [
                    {
                        name: "广告主管理",
                        nav: "/home/advertiser/advertiserList"
                    }
                ]
            },
            {
                ...
                childs: [
               		{
                        name: "程序化渠道",
                        nav: "/home/programmaticChannel/channelList"
                    },
                    {
                        name: "媒体管理",
                        nav: "/home/mediaManagement/mediaManagement"
                    },
                    {
                        name: "媒体分类管理",
                        nav: "/home/mediaTypeManagement/mediaTypeManagementList"
                    },
                    /*{
                        name: "调量管理",
                        nav: "/home/channel/overshootManage"
                    },*/                    {
                        name: "创意规格管理",
                        nav: "/home/creativeSizeManagement/imageSize"
                    },                ]
            },
            {
                name: "财务管理",
                ...
                childs: [
                    {
                        name: "项目估算",
                        nav: "/home/finance/projectEstimate"
                    },
                ]
            },
            {
                ...
                childs: [
                    {
                        name: "综合报表",
                        nav: "/home/datacenter/comprehensiveReport"
                    },
                    {
                        name: "数据图表",
                        nav: "/home/data/dataChart"
                    },
                    {
                        name: "落地页跟踪",
                        nav: "/home/landingPageTracking/duringAnalysis"
                    },
                ]
            }
        ],
        WEEKS_ARRAY_ONE_SEVEN: ["星期日","星期一","星期二","星期三","星期四","星期五","星期六"],
        REASON_OBJ: {
			"01": "项目总预算达到上限",
			"02": "活动日预算达到上限",
			"03": "展现数达到上限",
