import { Directive, ElementRef, Renderer,Input, OnDestroy, OnChanges,AfterViewInit } from "@angular/core";
...
export class ValidationDirective implements OnDestroy,OnChanges,AfterViewInit{
