...
declare var $;
declare var require;
let path = require("./mediaManagementProgram.html");
...
export class mediaManagementProgramComponent implements OnInit {
   /* headtitletext={
        appnumber:"",
        sameappnumber:"",
        appblacknumber:"",
    ...
    constructor(
        ...
        this.allCheck = false;
        this.adxId = this.route.snapshot.params["id"];
    }
            ...
            result => {
                ...
                for(let i = 0 ;i<this.adxdatas.length;i++){
                    if(this.adxdatas[i].id == this.adxId){
                        this.adxName = this.adxdatas[i].name;
                    }
                }
            },
            error => {
    ...
    add(){
        this.router.navigate(["/home/programmaticChannel/addMediaManagementProgram/",this.adxId]);
    }
    editMediaManagement(row){
        this.router.navigate(["/home/programmaticChannel/editMediaManagementProgram/",row.adxId,row.id]);
    }
