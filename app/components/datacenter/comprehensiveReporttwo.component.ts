...
import "./comprehensiveReporttwo.component.less";

declare var $;
declare var require;
let path = require("./comprehensiveReporttwo.html");
...
export class comprehensiveReporttwoComponent implements OnInit {
    selectedprovince=[];
    datagroupstongji = [
        {name:"原始展现数"},
        {name:"原始点击数"},
