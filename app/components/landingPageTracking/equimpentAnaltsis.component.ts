...
declare var $;
declare var require;
let path = require("./equimpentAnaltsis.html");

@Component({
	selector: "ng-equimpentAnaltsis",
	template: path
})

export class EquimpentAnaltsisComponent implements OnInit {
    @ViewChild("equipmentAnalysisEcharts") equipmentAnalysisEcharts;
    
	@ViewChild("equipmentAnalysisTable") equipmentAnalysisTable;

    private equipmentAnalysisData : Array<object> = [];

    private equipmentAnalysisObject;
	...
	ngOnInit() {
        this.equipmentAnalysisObject = echarts.init(this.equipmentAnalysisEcharts.nativeElement);
