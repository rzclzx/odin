...
declare var $;
declare var require;
let path = require("./spatialAnalysis.html");

@Component({
	selector: "ng-spatialAnalysis",
	template: path
})

export class SpatialAnalysisComponent implements OnInit {
    @ViewChild("spatialAnalysisEcharts") spatialAnalysisEcharts;

	@ViewChild("spatialAnalysisTable") spatialAnalysisTable;
	
    private spatialAnalysisData : Array<object> = [];
    
    private spatialAnalysisObject;
	...
	ngOnInit() {
        this.spatialAnalysisObject = echarts.init(this.spatialAnalysisEcharts.nativeElement);       
