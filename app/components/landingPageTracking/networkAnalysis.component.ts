...
declare var $;
declare var require;
let path = require("./networkAnalysis.html");

@Component({
	selector: "ng-networkAnalysis",
	template: path
})

export class NetworkAnalysisComponent implements OnInit {
    @ViewChild("networkAnalysisEcharts") networkAnalysisEcharts;
    
	@ViewChild("networkAnalysisTable") networkAnalysisTable;
	
    private networkAnalysisData : Array<object> = [];
    
    private networkAnalysisObject;
	...
	ngOnInit() {
        this.networkAnalysisObject = echarts.init(this.networkAnalysisEcharts.nativeElement);
